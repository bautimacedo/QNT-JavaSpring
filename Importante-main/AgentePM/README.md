...
| `AGENTE_WORKFLOW.md` | **Agente de ejecución** — toma prompts de la cola y los implementa con lock multi-agente |
...
### Opción D — Sesión de planificación con el PM (genera prompts)
...
### Opción E — Generar un documento específico
